function ComponentCharacterSelect() : ComponentBase() constructor{
	...
	self.init = function(){
		...
		self.backup_lines = renderer.add_sprite("lines")
		self.background = renderer.add_sprite("bg")
		self.character_art = renderer.add_sprite("x")
	}
	...
	self.step = function(){
		...
		if(self.input.get_input_pressed("left")){
			...
			renderer.change_sprite(self.character_art, other.characters[other.character_index].image_folder)
		}
