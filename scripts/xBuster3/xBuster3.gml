function xBusterX3() : ProjectileWeapon() constructor{
	self.data = [xBuster11Data,xBuster12Data,xBuster33Data,xBuster34_1Data,xBuster35_1Data];
	self.charge_limit = 4;
	self.cost = 0;
	self.title = "X BUSTER";
...
function xBuster34_1Data() : ProjectileData() constructor{
...
function xBuster35_1Data() : ProjectileData() constructor{
	self.comboiness = 5;//all the drill bits should connect
	self.damage = 3;
...
function xBuster35_2Data() : ProjectileData() constructor{
...
function xBuster35_3Data() : ProjectileData() constructor{
	self.comboiness = 15;//all the drill bits should connect
	self.damage = 5;
	self.animation = "undefined";
	self.stock_shot = xBuster12Data;
